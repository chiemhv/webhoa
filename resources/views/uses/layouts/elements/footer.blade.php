<footer id="footer"><!--Footer-->
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2017 CHIMSHOP.COM - SHOP ONLINE</p>
					<p class="pull-right">Designed by <span><a target="_blank" href="http://www.chimshop.com">Hà Văn Chiêm</a></span></p>
				</div>
			</div>
		</div>
